...
docker tag item-app:v1 andydarmawan243/item-app:item-app-v1  # Perintah ini mengubah nama dan tag Docker image "item-app:v1" menjadi "andydarmawan243/item-app:item-app-v1".
...
docker push andydarmawan243/item-app:item-app-v1  # Perintah ini mengunggah Docker image "andydarmawan243/item-app:item-app-v1" ke Docker Hub
